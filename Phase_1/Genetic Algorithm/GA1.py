...
class Genetic_Algorithm:
    def __init__(self, n_customers, n_barbers, operation_list, customer_type, max_obj_var):
        self.barber_model = BS(n_customers, n_barbers, operation_list, customer_type)
        self.objlist = []
        self.objolist = []
